...
import {fetchSecAnalysis} from "../api"; // Include this CSS file to style the sidebar layout
  ...
  return (
    <div className="app-container">
      ...
      <div className="sidebar">
        <div
          className={`tab ${activeTab === "PCA Sector" ? "active" : ""}`}
          onClick={() => setActiveTab("PCA Sector")}
        >
          PCA Sector
        </div>
        <div
          className={`tab ${activeTab === "PCA Cluster" ? "active" : ""}`}
          onClick={() => setActiveTab("PCA Cluster")}
        >
          PCA Cluster
        </div>
        <div
        ...
        <div
          className={`tab ${activeTab === "Dendrogram" ? "active" : ""}`}
